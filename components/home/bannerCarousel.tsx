...
const BannerCarousel = ({
  WebsiteBannerCarousels,
}: {
  WebsiteBannerCarousels: string[];
}) => {
  ...
  // Use the passed props as desktop images
  const images = isMobile ? mobileImages : WebsiteBannerCarousels;
    ...
    <div className={`relative w-full h-[400px] overflow-hidden mb-[20px]`}>
      {images.length === 0 ? (
        <div className="flex justify-center items-center h-full">
          <div className="loader"></div> {/* Add a spinner or placeholder */}
        </div>
      ) : (
        <>
